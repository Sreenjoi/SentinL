...
export default function CommandPalette() {
  ...
  const items = [
    ...
    { title: "Mod Queue", breadcrumbs: "Moderation > Mod Queue", path: "/moderation#queue", icon: ListChecks, description: "Review flagged messages and choose what happens next" },
    { title: "User Reports", breadcrumbs: "Moderation > Reports", path: "/moderation#reports", icon: MessageSquareWarning, description: "Handle reports submitted by members" },
    ...
    { title: "Flagging Strictness", breadcrumbs: "Moderation > Settings > Flagging strictness", path: "/moderation#settings", icon: Shield, description: "Control how sure SentinL should be before it flags" },
    { title: "Read Nearby Chat", breadcrumbs: "Moderation > Settings > Context", path: "/moderation#settings", icon: Shield, description: "Let SentinL use replies and nearby messages for tougher calls" },
    ...
    { title: "Community DNA", breadcrumbs: "Settings > Community DNA", path: "/settings#dna", icon: Logo, description: "Teach SentinL your server rules and tone" },
    ...
    { title: "Command List", breadcrumbs: "Settings > Command List", path: "/settings#commands", icon: Command, description: "See the built-in SentinL commands for your server" },
    ...
    { title: "Commands Guide", breadcrumbs: "Resources > Commands Guide", path: "/commands-guide", icon: Command, description: "Plain-English help for SentinL commands", locked: false },
    ...
    { title: "Leveling & XP", breadcrumbs: "Leveling & XP", path: "/leveling", icon: Trophy, description: "Set how members earn XP and rewards", locked: !isPro },
    ...
    { title: "Training Feedback", breadcrumbs: "Analytics > Training Feedback", path: "/analytics#training", icon: Bot, description: "Review what SentinL learned from moderator corrections", locked: !isPro },
