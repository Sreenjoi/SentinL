...
const CATEGORIES: Category[] = [
  {
    ...
    title: "Setup",
    description:
      "Commands that help you get SentinL ready for your server.",
    icon: SettingsIcon,
    commands: [
      {
        name: "/setup",
  ...
  },
  {
    ...
    title: "AI Moderation",
    description:
      "Control how SentinL checks messages and handles moderation.",
    icon: Shield,
    commands: [
      {
      ...
      },
      {
        ...
        permission: "everyone",
        description:
          "Shows whether AI checks are healthy, slowed, or waiting to recover. Bot owner only.",
        options: [],
      ...
      {
        name: "/keywords list",
        description: "Shows the keywords SentinL checks before using AI.",
        options: [],
    ...
    commands: [
      {
        ...
        description:
          "Sets the public welcome message sent when a member joins. You can use placeholders to personalize it.",
        options: [
          {
            name: "channel",
            type: "Channel",
          ...
          },
          {
            ...
            required: true,
            description:
              "The message text. Use {user} to mention the member and {server} for the server name.",
          },
        ],
        example:
      ...
      },
      {
        ...
        description:
          "Shows a clear summary of what happens when someone joins your server.",
        options: [],
  ...
  },
  {
    ...
    title: "Auto-Assign",
    description:
      "Choose a role SentinL gives to new members automatically.",
    icon: Shield,
    commands: [
      {
        name: "/autorole set",
...
export default function CommandsGuide() {
  ...
  return (
    ...
    >
      <div className="px-8 py-6 border-b border-primary/20 flex justify-between items-center bg-primary text-white">
