...
export default function AdminFeedback() {
  ...
  return (
    ...
    >
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-on-surface tracking-tight">User Feedback</h1>
        <p className="text-sm text-text-secondary mt-2">Manage bug reports and feature requests from your users.</p>
      </div>
