  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div className="glass-panel rounded-[2rem] border border-outline-variant/30 shadow-sm overflow-hidden flex flex-col p-5 sm:p-6 justify-center h-[350px]">
          <div className="text-[10px] sm:text-[11px] text-text-secondary uppercase tracking-widest font-black mb-6 flex items-center justify-between border-b border-outline-variant/30 pb-3">
            <span>General Statistics</span>
            <Shield className="w-3.5 h-3.5 text-primary" />
          </div>
          <div className="grid grid-cols-2 gap-4 gap-y-6">
            <div className="text-left">
              <div className="text-[9px] sm:text-[10px] text-text-secondary uppercase tracking-widest font-bold mb-1">
                Today's Flags
              </div>
              <div className="text-xl sm:text-2xl font-extrabold text-on-surface">
            ...
            <div className="text-left">
              ...
              <div className="text-xl sm:text-2xl font-extrabold text-on-surface opacity-80">
            ...
            <div className="text-left col-span-2 pt-3 mt-1 border-t border-outline-variant/30 flex items-center justify-between">
              <div className="text-[9px] sm:text-[10px] text-text-secondary uppercase tracking-widest font-bold">
                Time Saved
              </div>
