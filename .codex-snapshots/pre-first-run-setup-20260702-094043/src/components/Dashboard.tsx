    ...
    >
      ...
      {botGuilds?.includes(selectedServerId) && !isServerActiveGlobally && !intentsWarning && (
        <div className="bg-warning/10 border-[4px] border-warning shadow-[0_0_15px_rgba(251,146,60,0.5)] animate-pulse rounded-2xl p-4 flex items-start flex-col sm:flex-row gap-3 w-full">
          ...
          <Link to="/moderation#settings" className="sm:ml-auto mt-2 sm:mt-0 bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-colors flex items-center justify-center">
            Activate Server
          </Link>
        </div>
      )}
