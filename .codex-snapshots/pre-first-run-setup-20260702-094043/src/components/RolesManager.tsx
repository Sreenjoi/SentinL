  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="px-6 sm:px-8 py-5 sm:py-6 border-b border-outline-variant/20 bg-surface-container/30 rounded-t-[2rem] sm:rounded-t-[2.5rem] shrink-0">
          <h2 className="text-lg sm:text-xl font-extrabold text-on-surface tracking-tight text-black">
            Server Onboarding
          </h2>
